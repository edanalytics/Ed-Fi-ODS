...
namespace EdFi.Ods.Api.Extensions
{
    public static class TypeExtensions
    {
        ...
        public static bool IsDecoratorOf<TService>(this TypeInfo type)
        {
            ...
            if (!type.IsImplementationOf<TService>() || type.DeclaredConstructors.Count() != 1)
            {
                return false;
            }
        ...
        {
            return subjectType.IsAssignableTo<TService>() && !subjectType.IsInterface && !subjectType.IsAbstract;
        }
    }
}
